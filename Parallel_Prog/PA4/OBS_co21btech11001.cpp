...
// Obstruction Free Snapshot Implementation
To compile: g++ OBS_co21btech11001.cpp -o obs
To run: ./obs inp-params.txt
*/
...
MRMW_OBS_Snap<int> *MRMW_Snap_Obj = nullptr;
...
signed main(signed argc, char* argv[]) {
    ...
    MRMW_Snap_Obj = new MRMW_OBS_Snap<int>(M);
